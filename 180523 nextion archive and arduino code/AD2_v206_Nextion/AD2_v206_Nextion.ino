...
//B icons
//retirar isso e as funções envolvidas nisso
/*const int b00 = 0;
const int b25 = 1;
const int b50 = 2;
const int b75 = 3;
...
byte charging[8] = { //isso eu posso tirar
  B00001,
  B00110,
  B11100,
  B11110,
...
byte bZero[8] = {//isso eu posso tirar
  B01110,
  B11011,
  B10001,
  B10001,
...
byte bLow[8] = {//isso eu posso tirar
  B01110,
  B11011,
  B10001,
  B10001,
...
byte bMid[8] = {//isso eu posso tirar
  B01110,
  B11011,
  B10001,
  B10001,
...
byte bHigh[8] = {//isso eu posso tirar
  B01110,
  B11011,
  B10001,
  B11111,
...
byte bFull[8] = {//isso eu posso tirar
  B01110,
  B11111,
  B11111,
  B11111,
...
byte levelBubble[8] = {//isso eu posso tirar
  B11111,
  B11111,
  B10001,
  B00000,
...
byte wicon[8] = {//isso eu posso tirar
  B00000,
  B01110,
  B10001,
  B00100,
